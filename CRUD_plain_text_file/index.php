...
if( isset($_POST['submit'])){
    ...
    if($id){
        ...
        if($fname!="" && $lname!=""&&$roll!=""){
            ...
            if($result){
                header( 'location: /CRUD_plain_text_file/index.php?task=report' );
            }else{
                $error = 1;
            }
        }
        ...
        if ($fname != "" && $lname != "" && $roll != ""){
            ...
            if($result){
                ...
                header( 'location: /CRUD_plain_text_file/index.php?task=report' );
                // header("C:\\Users\\zzzzz\\\Desktop\\PHP_SmallProject\\CRUD_plain_text_file\\index.php?task=report");
            }else{
                $error = 1;
            }
        }
...
<head>
    <meta charset="UTF-8">
    <title>CRUD_PLAIN_TEXT_FILE</title>
            ...
            <div class="row">
                <div class="column column-60 column-offset-20">
                    <form action="index.php?task=add" method="POST">
                        ...
                        <label for="lnamev">Last Name</label>
